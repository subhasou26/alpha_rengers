...
export function Footer() {
  return (
    <footer className="bg-green-900 py-4 relative overflow-hidden">
      ...
      <div className="absolute right-0 bottom-0 w-16 pointer-events-none">
        <div className="absolute -right-2 bottom-0 transform rotate-15 text-emerald-600/[0.03] w-20 h-32">
          <SmallLeaf />
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 relative">
        <div className="flex items-center justify-between">
          ...
          <a
            href="https://github.com/subhasou26/alpha_rengers"
            target="_blank"
